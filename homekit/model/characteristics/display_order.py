...
class DisplayOrderCharacteristic(AbstractCharacteristic):
    """
...
class DisplayOrderCharacteristicMixin(object):
    def __init__(self, iid):
        self._displayOrder = DisplayOrderCharacteristic(iid)
        self.characteristics.append(self._displayOrder)

    def set_on_set_callback(self, callback):
        self._displayOrder.set_set_value_callback(callback)

    def set_on_get_callback(self, callback):
        self._displayOrder.set_get_value_callback(callback)
