...
class PictureModeCharacteristic(AbstractCharacteristic):
    """
    ...
    def __init__(self, iid):
        AbstractCharacteristic.__init__(self, iid, CharacteristicsTypes.PICTURE_MODE,
...
class PictureModeCharacteristicMixin(object):
    def __init__(self, iid):
        self._pictureMode = PictureModeCharacteristic(iid)
        self.characteristics.append(self._pictureMode)

    def set_on_set_callback(self, callback):
        self._pictureMode.set_set_value_callback(callback)

    def set_on_get_callback(self, callback):
        self._pictureMode.set_get_value_callback(callback)
