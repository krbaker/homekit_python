...
from homekit.model.services import LightBulbService, TelevisionService
...
if __name__ == '__main__':
    ...
    try:
        ...
        accessory = Accessory('TestTV', 'lusiardi.de', 'Demoserver', '0001', '0.1')
        lightBulbService = TelevisionService()
